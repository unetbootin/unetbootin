...
**
** Created: Fri May 30 22:27:55 2008
...
static const uint qt_meta_data_QMdiArea[] = {
 ...
 // enum data: key, value
     507, uint(QMdiArea::CreationOrder),
     521, uint(QMdiArea::StackingOrder),
     535, uint(QMdiArea::ActivationHistoryOrder),
     558, uint(QMdiArea::SubWindowView),
     572, uint(QMdiArea::TabbedView),
...
static const char qt_meta_stringdata_QMdiArea[] = {
    ...
    "ViewMode\0viewMode\0QTabWidget::TabShape\0"
...
const QMetaObject QMdiArea::staticMetaObject = {
    { &QAbstractScrollArea::staticMetaObject, qt_meta_stringdata_QMdiArea,
      qt_meta_data_QMdiArea, qt_meta_extradata_QMdiArea }
};
...
int QMdiArea::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: *reinterpret_cast< QTabWidget::TabShape*>(_v) = tabShape(); break;
        case 4: *reinterpret_cast< QTabWidget::TabPosition*>(_v) = tabPosition(); break;
        }
        _id -= 5;
        ...
        case 3: setTabShape(*reinterpret_cast< QTabWidget::TabShape*>(_v)); break;
        case 4: setTabPosition(*reinterpret_cast< QTabWidget::TabPosition*>(_v)); break;
        }
        _id -= 5;
