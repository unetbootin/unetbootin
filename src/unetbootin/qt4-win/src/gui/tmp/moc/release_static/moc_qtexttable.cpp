...
**
** Created: Fri May 30 22:33:23 2008
...
static const char qt_meta_stringdata_QTextTable[] = {
    "QTextTable\0"
};

const QMetaObject QTextTable::staticMetaObject = {
    { &QTextFrame::staticMetaObject, qt_meta_stringdata_QTextTable,
      qt_meta_data_QTextTable, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTextTable))
