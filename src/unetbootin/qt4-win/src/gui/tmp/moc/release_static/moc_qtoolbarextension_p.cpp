...
**
** Created: Fri May 30 22:33:53 2008
...
static const char qt_meta_stringdata_QToolBarExtension[] = {
    "QToolBarExtension\0\0o\0"
    "setOrientation(Qt::Orientation)\0"
};

const QMetaObject QToolBarExtension::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_QToolBarExtension,
      qt_meta_data_QToolBarExtension, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QToolBarExtension))
