...
**
** Created: Fri May 30 22:33:41 2008
...
static const char qt_meta_stringdata_QDockWidgetLayout[] = {
    "QDockWidgetLayout\0"
};

const QMetaObject QDockWidgetLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QDockWidgetLayout,
      qt_meta_data_QDockWidgetLayout, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDockWidgetLayout))
