...
public:
    JSSVGPathSegLinetoHorizontalRel(KJS::ExecState*, SVGPathSegLinetoHorizontalRel*);
...
class JSSVGPathSegLinetoHorizontalRelPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    JSSVGPathSegLinetoHorizontalRelPrototype(KJS::ExecState* exec)
