...
public:
    JSSVGDefsElement(KJS::ExecState*, SVGDefsElement*);
...
class JSSVGDefsElementPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    bool getOwnPropertySlot(KJS::ExecState*, const KJS::Identifier&, KJS::PropertySlot&);
    JSSVGDefsElementPrototype(KJS::ExecState* exec)
        : KJS::JSObject(JSSVGElementPrototype::self(exec)) { }
};

class JSSVGDefsElementPrototypeFunction : public KJS::InternalFunctionImp {
public:
    JSSVGDefsElementPrototypeFunction(KJS::ExecState* exec, int i, int len, const KJS::Identifier& name)
