...
public:
    JSHTMLBlockquoteElement(KJS::ExecState*, HTMLBlockquoteElement*);
...
class JSHTMLBlockquoteElementPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    JSHTMLBlockquoteElementPrototype(KJS::ExecState* exec)
