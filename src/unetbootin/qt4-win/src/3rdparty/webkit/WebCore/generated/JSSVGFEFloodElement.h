...
public:
    JSSVGFEFloodElement(KJS::ExecState*, SVGFEFloodElement*);
...
class JSSVGFEFloodElementPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    JSSVGFEFloodElementPrototype(KJS::ExecState* exec)
