...
public:
    JSSVGPathSegCurvetoQuadraticSmoothAbs(KJS::ExecState*, SVGPathSegCurvetoQuadraticSmoothAbs*);
...
class JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype(KJS::ExecState* exec)
