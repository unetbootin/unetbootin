...
public:
    JSHTMLMapElement(KJS::ExecState*, HTMLMapElement*);
...
class JSHTMLMapElementPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    JSHTMLMapElementPrototype(KJS::ExecState* exec)
