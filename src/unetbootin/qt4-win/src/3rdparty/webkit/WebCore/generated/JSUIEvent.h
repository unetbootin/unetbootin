...
public:
    JSUIEvent(KJS::ExecState*, UIEvent*);
...
class JSUIEventPrototypeFunction : public KJS::InternalFunctionImp {
public:
    JSUIEventPrototypeFunction(KJS::ExecState* exec, int i, int len, const KJS::Identifier& name)
