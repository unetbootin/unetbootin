...
public:
    JSHTMLBaseElement(KJS::ExecState*, HTMLBaseElement*);
...
class JSHTMLBaseElementPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    JSHTMLBaseElementPrototype(KJS::ExecState* exec)
