...
public:
    JSHTMLParagraphElement(KJS::ExecState*, HTMLParagraphElement*);
...
class JSHTMLParagraphElementPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState* exec);
    virtual const KJS::ClassInfo* classInfo() const { return &info; }
    static const KJS::ClassInfo info;
    JSHTMLParagraphElementPrototype(KJS::ExecState* exec)
