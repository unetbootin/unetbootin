...
static const char qt_meta_stringdata_QSqlDriverPlugin[] = {
    "QSqlDriverPlugin\0"
};

const QMetaObject QSqlDriverPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QSqlDriverPlugin,
      qt_meta_data_QSqlDriverPlugin, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSqlDriverPlugin))
	return static_cast<void*>(const_cast< QSqlDriverPlugin*>(this));
    if (!strcmp(_clname, "QSqlDriverFactoryInterface"))
	return static_cast< QSqlDriverFactoryInterface*>(const_cast< QSqlDriverPlugin*>(this));
    if (!strcmp(_clname, QSqlDriverFactoryInterface_iid))
	return static_cast< QSqlDriverFactoryInterface*>(const_cast< QSqlDriverPlugin*>(this));
    if (!strcmp(_clname, "com.trolltech.Qt.QFactoryInterface"))
	return static_cast< QFactoryInterface*>(static_cast< QSqlDriverFactoryInterface*>(const_cast< QSqlDriverPlugin*>(this)));
