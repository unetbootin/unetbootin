...
/*! \class QFutureWatcher
    ...
    \snippet doc/src/snippets/code/src.corelib.concurrent.qfuturewatcher.cpp 0
...
/*!
    ...
    the GUI event loop, QFutureWathcer limits the progress signal emission
    ...
    progressValue  == maximum) will always be delivered.
*/
