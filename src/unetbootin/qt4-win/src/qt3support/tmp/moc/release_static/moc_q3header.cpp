...
**
** Created: Fri May 30 22:41:25 2008
...
int Q3Header::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: released((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: sizeChange((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 4: indexChange((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 5: sectionClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: moved((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 7: sectionHandleDoubleClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 8: setUpdatesEnabled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 9: setOffset((*reinterpret_cast< int(*)>(_a[1]))); break;
        }
        _id -= 10;
    }
