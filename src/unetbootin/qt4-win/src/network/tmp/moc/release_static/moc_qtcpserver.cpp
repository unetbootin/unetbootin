...
**
** Created: Fri May 30 22:19:52 2008
...
static const char qt_meta_stringdata_QTcpServer[] = {
    "QTcpServer\0\0newConnection()\0"
};

const QMetaObject QTcpServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTcpServer,
      qt_meta_data_QTcpServer, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTcpServer))
