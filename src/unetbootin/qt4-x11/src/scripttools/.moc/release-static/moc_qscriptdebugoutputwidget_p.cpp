...
**
** Created: Thu Mar 5 20:26:24 2009
**      by: The Qt Meta Object Compiler version 61 (Qt 4.5.0)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../../debugging/qscriptdebugoutputwidget_p.h"
...
static const char qt_meta_stringdata_QScriptDebugOutputWidget[] = {
    "QScriptDebugOutputWidget\0"
};

const QMetaObject QScriptDebugOutputWidget::staticMetaObject = {
    { &QScriptDebugOutputWidgetInterface::staticMetaObject, qt_meta_stringdata_QScriptDebugOutputWidget,
      qt_meta_data_QScriptDebugOutputWidget, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QScriptDebugOutputWidget))
