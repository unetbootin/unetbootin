...
**
** Created: Thu Mar 5 20:26:23 2009
**      by: The Qt Meta Object Compiler version 61 (Qt 4.5.0)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../../debugging/qscriptdebugoutputwidgetinterface_p.h"
...
static const char qt_meta_stringdata_QScriptDebugOutputWidgetInterface[] = {
    "QScriptDebugOutputWidgetInterface\0"
};

const QMetaObject QScriptDebugOutputWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptDebugOutputWidgetInterface,
      qt_meta_data_QScriptDebugOutputWidgetInterface, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QScriptDebugOutputWidgetInterface))
