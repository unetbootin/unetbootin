...
**
** Created: Thu Mar 5 18:52:42 2009
...
static const uint qt_meta_data_QTextEdit[] = {
 ...
 // properties: name, type, flags
     ...
     966,  923, 0x01095103,
     995,  982, 0x0009510b,
    1012, 1008, 0x02095103,
    1034,  923, 0x01095103,
    1043,  944, 0x0a595103,
    1048,  944, 0x0a094103,
    1058,  923, 0x01095103,
    1072, 1008, 0x02095103,
    1085,  923, 0x01095103,
    1100, 1008, 0x02095103,
    1137, 1112, 0x0009510b,
 ...
 // enum data: key, value
    1158, uint(QTextEdit::NoWrap),
    1165, uint(QTextEdit::WidgetWidth),
    1177, uint(QTextEdit::FixedPixelWidth),
    1193, uint(QTextEdit::FixedColumnWidth),
    1210, uint(QTextEdit::AutoNone),
    1219, uint(QTextEdit::AutoBulletList),
    1234, uint(QTextEdit::AutoAll),

       0        // eod
};

static const char qt_meta_stringdata_QTextEdit[] = {
    "QTextEdit\0\0textChanged()\0b\0"
    ...
    "cursorPositionChanged()\0f\0"
    "currentFontChanged(QFont)\0c\0"
    "currentColorChanged(QColor)\0s\0"
    "setFontPointSize(qreal)\0fontFamily\0"
    "setFontFamily(QString)\0w\0setFontWeight(int)\0"
    "setFontUnderline(bool)\0setFontItalic(bool)\0"
    "setTextColor(QColor)\0"
    "setTextBackgroundColor(QColor)\0"
    "setCurrentFont(QFont)\0a\0"
    "setAlignment(Qt::Alignment)\0text\0"
...
int QTextEdit::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: currentFontChanged((*reinterpret_cast< const QFont(*)>(_a[1]))); break;
        case 8: currentColorChanged((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 9: setFontPointSize((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 10: setFontFamily((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 11: setFontWeight((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 12: setFontUnderline((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 13: setFontItalic((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 14: setTextColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 15: setTextBackgroundColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 16: setCurrentFont((*reinterpret_cast< const QFont(*)>(_a[1]))); break;
        case 17: setAlignment((*reinterpret_cast< Qt::Alignment(*)>(_a[1]))); break;
        case 18: setPlainText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 19: setHtml((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 20: setText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 21: cut(); break;
        case 22: copy(); break;
        case 23: paste(); break;
        case 24: undo(); break;
        ...
        case 28: insertPlainText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 29: insertHtml((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 30: append((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 31: scrollToAnchor((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 32: zoomIn((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 33: zoomIn(); break;
        case 34: zoomOut((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 35: zoomOut(); break;
        case 36: setModified((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 37: setModified(); break;
        case 38: setColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 39: d_func()->_q_repaintContents((*reinterpret_cast< const QRectF(*)>(_a[1]))); break;
        case 40: d_func()->_q_currentCharFormatChanged((*reinterpret_cast< const QTextCharFormat(*)>(_a[1]))); break;
        case 41: d_func()->_q_adjustScrollbars(); break;
        case 42: d_func()->_q_ensureVisible((*reinterpret_cast< const QRectF(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 43;
    }
...
// SIGNAL 7
void QTextEdit::currentFontChanged(const QFont & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 8
void QTextEdit::currentColorChanged(const QColor & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
