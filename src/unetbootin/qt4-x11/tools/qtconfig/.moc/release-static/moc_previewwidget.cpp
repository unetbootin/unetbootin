...
**
** Created: Thu Mar 5 20:59:31 2009
...
const QMetaObject PreviewWidget::staticMetaObject = {
    { &PreviewWidgetBase::staticMetaObject, qt_meta_stringdata_PreviewWidget,
      qt_meta_data_PreviewWidget, 0 }
};
...
void *PreviewWidget::qt_metacast(const char *_clname)
{
    ...
    return PreviewWidgetBase::qt_metacast(_clname);
}

int PreviewWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = PreviewWidgetBase::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
