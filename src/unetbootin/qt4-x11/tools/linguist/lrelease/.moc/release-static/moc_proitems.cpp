/****************************************************************************
** Meta object code from reading C++ file 'proitems.h'
**
** Created: Thu Mar 5 20:57:13 2009
**      by: The Qt Meta Object Compiler version 61 (Qt 4.5.0)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../../../shared/proitems.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'proitems.h' doesn't include <QObject>."
...
void *ProFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ProBlock"))
        return static_cast< ProBlock*>(const_cast< ProFile*>(this));
