...
**
** Created: Thu Mar 5 20:56:00 2009
...
static const char qt_meta_stringdata_PhraseModel[] = {
    "PhraseModel\0"
};

const QMetaObject PhraseModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_PhraseModel,
      qt_meta_data_PhraseModel, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PhraseModel))
