...
static const char qt_meta_stringdata_QDesignerWidgetFactoryInterface[] = {
    "QDesignerWidgetFactoryInterface\0"
};

const QMetaObject QDesignerWidgetFactoryInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDesignerWidgetFactoryInterface,
      qt_meta_data_QDesignerWidgetFactoryInterface, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDesignerWidgetFactoryInterface))
        return static_cast<void*>(const_cast< QDesignerWidgetFactoryInterface*>(this));
