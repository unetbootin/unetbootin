...
**
** Created: Thu Mar 5 20:46:18 2009
...
const QMetaObject QtResourceModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtResourceModel,
      qt_meta_data_QtResourceModel, 0 }
};
...
int QtResourceModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: qrcFileModifiedExternally((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: d_func()->slotFileChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
