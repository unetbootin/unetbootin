...
#include "../../shared/metadatabase_p.h"
...
static const char qt_meta_stringdata_qdesigner_internal__MetaDataBase[] = {
    "qdesigner_internal::MetaDataBase\0\0"
    "object\0slotDestroyed(QObject*)\0"
};

const QMetaObject qdesigner_internal::MetaDataBase::staticMetaObject = {
    { &QDesignerMetaDataBaseInterface::staticMetaObject, qt_meta_stringdata_qdesigner_internal__MetaDataBase,
      qt_meta_data_qdesigner_internal__MetaDataBase, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__MetaDataBase))
        return static_cast<void*>(const_cast< MetaDataBase*>(this));
...
int qdesigner_internal::MetaDataBase::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: slotDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
