...
**
** Created: Thu Mar 5 20:51:58 2009
...
static const char qt_meta_stringdata_qdesigner_internal__SignalSlotEditor[] = {
    "qdesigner_internal::SignalSlotEditor\0"
};

const QMetaObject qdesigner_internal::SignalSlotEditor::staticMetaObject = {
    { &ConnectionEdit::staticMetaObject, qt_meta_stringdata_qdesigner_internal__SignalSlotEditor,
      qt_meta_data_qdesigner_internal__SignalSlotEditor, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__SignalSlotEditor))
        return static_cast<void*>(const_cast< SignalSlotEditor*>(this));
