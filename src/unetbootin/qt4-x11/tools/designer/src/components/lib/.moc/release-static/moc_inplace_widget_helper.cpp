...
**
** Created: Thu Mar 5 20:52:38 2009
...
static const char qt_meta_stringdata_qdesigner_internal__InPlaceWidgetHelper[] = {
    "qdesigner_internal::InPlaceWidgetHelper\0"
};

const QMetaObject qdesigner_internal::InPlaceWidgetHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qdesigner_internal__InPlaceWidgetHelper,
      qt_meta_data_qdesigner_internal__InPlaceWidgetHelper, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__InPlaceWidgetHelper))
        return static_cast<void*>(const_cast< InPlaceWidgetHelper*>(this));
