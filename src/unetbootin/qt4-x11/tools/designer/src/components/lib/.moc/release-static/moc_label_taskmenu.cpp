...
static const char qt_meta_stringdata_qdesigner_internal__LabelTaskMenu[] = {
    "qdesigner_internal::LabelTaskMenu\0\0"
    "editRichText()\0"
};

const QMetaObject qdesigner_internal::LabelTaskMenu::staticMetaObject = {
    { &QDesignerTaskMenu::staticMetaObject, qt_meta_stringdata_qdesigner_internal__LabelTaskMenu,
      qt_meta_data_qdesigner_internal__LabelTaskMenu, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__LabelTaskMenu))
        return static_cast<void*>(const_cast< LabelTaskMenu*>(this));
