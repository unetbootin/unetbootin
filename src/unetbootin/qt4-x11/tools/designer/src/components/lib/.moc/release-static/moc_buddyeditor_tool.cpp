...
static const char qt_meta_stringdata_qdesigner_internal__BuddyEditorTool[] = {
    "qdesigner_internal::BuddyEditorTool\0"
};

const QMetaObject qdesigner_internal::BuddyEditorTool::staticMetaObject = {
    { &QDesignerFormWindowToolInterface::staticMetaObject, qt_meta_stringdata_qdesigner_internal__BuddyEditorTool,
      qt_meta_data_qdesigner_internal__BuddyEditorTool, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qdesigner_internal__BuddyEditorTool))
        return static_cast<void*>(const_cast< BuddyEditorTool*>(this));
