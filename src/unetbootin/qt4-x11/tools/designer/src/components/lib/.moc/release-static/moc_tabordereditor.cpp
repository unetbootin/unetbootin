...
**
** Created: Thu Mar 5 20:52:40 2009
...
const QMetaObject qdesigner_internal::TabOrderEditor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_qdesigner_internal__TabOrderEditor,
      qt_meta_data_qdesigner_internal__TabOrderEditor, 0 }
};
...
int qdesigner_internal::TabOrderEditor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: setBackground((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 1: updateBackground(); break;
        case 2: widgetRemoved((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 3: initTabOrder(); break;
        case 4: showTabOrderDialog(); break;
        default: ;
        }
        _id -= 5;
    }
